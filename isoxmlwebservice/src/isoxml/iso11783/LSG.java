 ...
 *         &lt;element ref="{}PNT" maxOccurs="unbounded"/>
 *       &lt;/choice>
...
public class LSG {
     ...
     * This is why there is not a <CODE>set</CODE> method for the pnt property.
     * 
     * <p>
     ...
     * 
     */
    public List<PNT> getPNT() {
        if (pnt == null) {
            pnt = new ArrayList<PNT>();
        }
        return this.pnt;
    }
