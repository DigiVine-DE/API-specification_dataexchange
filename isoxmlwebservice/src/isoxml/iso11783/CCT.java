 ...
 *         &lt;element ref="{}CCL" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/choice>
...
@XmlRootElement(name = "CCT")
public class CCT {

    @XmlElement(name = "CCL")
    protected List<CCL> ccl;
    ...
    /**
     * Gets the value of the ccl property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the ccl property.
     * 
     * <p>
     ...
     * 
     */
    public List<CCL> getCCL() {
        if (ccl == null) {
            ccl = new ArrayList<CCL>();
        }
        return this.ccl;
    }
